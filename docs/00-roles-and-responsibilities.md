...
|---|---|---|---|---|
| **Product Owner** | `.claude/agents/product-owner.md` | *What* and *why*, including the real-world business process behind a requirement. Requirements, acceptance criteria, scope calls, final sign-off. | `docs/01-po-requirements.md`, `docs/06-business-processes-and-domain-glossary.md`, `tracker/PROJECT_TRACKER.md` (`REQ-`/`PO-` rows) | Writes or edits source code. Makes architecture decisions. |
